...
export default function AddCandidates({itmid}) {
    console.log(itmid);
  ...
  console.log(resp)
       ...
       All the Best
       `,
            "sub":`Candidates Confirmation mail for ${query.id1} post`
        }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} style={{width:"150%",marginTop:'-3rem'}}>
        <div>
          <div 
          style={{
            width: "100%",
          ...
          className="ember-text-field text-left ember-view form-control">
            <div style={{display:'flex' }} className="d-flex justify-content-between">
              ...
              <div>
                <Button style={{textTransform:'capitalize',backgroundColor:'#f2f2f2',color:'#000000',padding:'2px 20px',borderRadius:'6px',border:'1px solid #cccccc'}}  onClick={() => { router.push('/publishopening') }} >Cancel</Button>
                &nbsp;&nbsp;
