...
export function Organizationsetup() {
  ...
  const handleSubmit = (e) => {
    ...
    const formData = {
      ...
      companyname: e.target.organization_name.value,
    ...
    axios.post(`${URLS}/api/company/${id}`,formData)
    .then((response)=>{
      localStorage.setItem("Cid", JSON.stringify(response.data.id)),
      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainForm}>
          <div className={styles.formTop}>
            ...
            <h2>Zoho Recruit - Organization Setup</h2>
            <svg
          ...
          <form className={styles.formBottom} onSubmit={handleSubmit}>
            ...
            <p className={styles.inputTitle}>
              Enter your organization details to get started with Zoho Recruit.
            </p>
            <br></br>
